...
pub fn install_other_app(app: &dyn ViaAnotherApp, version: &Version, platform: Platform, log: Log) -> Result<bool> {
    ...
    load_or_install(app, &RequestedVersion::Yard(version.to_owned()), platform, log)?;
    Ok(true)
}
