...
use crate::executables::{ExecutableNamePlatform, LoadAppOutcome};

/// Loads the given app at the given version
/// and returns a callable that executes it.
pub fn load_from_yard(app: &dyn AppDefinition, version: &Version, executable: &ExecutableNamePlatform, ctx: &RuntimeContext) -> Result<LoadAppOutcome> {
