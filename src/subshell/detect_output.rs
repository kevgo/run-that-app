...
use crate::cli;
use crate::prelude::*;
use crate::executable::{ExecutableFile, ExecutableCall};
...
pub(crate) fn detect_output(executable: &ExecutableFile, args: &[String], apps_to_include: &[ExecutableCall]) -> Result<ExitCode> {
