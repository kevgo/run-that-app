...
Installation across all possible operating systems is a complex and nuanced
problem without a good solution. Run-that-app bypasses this problem. You don't
really want to install applications, what you really want is running them. By
integrating installation and execution, run-that-app can drastically simplify
